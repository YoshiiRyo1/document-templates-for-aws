...
- design: [cloud-design-availability.md](../../design/doc_source/cloud-design-availability.md), [cloud-design-backup.md](../../design/doc_source/cloud-design-backup.md)
- survey: 可用性 > 稼働率、バックアップ/リストア、災害対策
...
- design: 該当する専用テンプレートなし（各サービス設計書内で個別に記載）
- survey: キャパシティ > 性能目標値、拡張性
...
- design: [cloud-design-monitoring.md](../../design/doc_source/cloud-design-monitoring.md), [cloud-design-patchmanagement.md](../../design/doc_source/cloud-design-patchmanagement.md), [cloud-design-deployprovisioning.md](../../design/doc_source/cloud-design-deployprovisioning.md), [cloud-design-configurationmanagement.md](../../design/doc_source/cloud-design-configurationmanagement.md), [cloud-design-log.md](../../design/doc_source/cloud-design-log.md)
- survey: 運用 > ジョブ管理、ログ管理、監視、アプリケーションデプロイ、運用維持管理。加えて、可用性 > パッチ管理（本体系では運用・保守性に分類）
...
- design: 該当する専用テンプレートなし
- survey: 該当するセクションなし（新規追加が望ましいカテゴリ）
...
- design: [cloud-design-security.md](../../design/doc_source/cloud-design-security.md), [cloud-design-network.md](../../design/doc_source/cloud-design-network.md)
- survey: 可用性 > コンプライアンス、攻撃防御、運用アカウント管理（本体系ではセキュリティに分類）
...
- design: [cloud-design-awsaccount.md](../../design/doc_source/cloud-design-awsaccount.md), [cloud-design-network.md](../../design/doc_source/cloud-design-network.md), [cloud-design-naming.md](../../design/doc_source/cloud-design-naming.md)
- survey: 環境 > ライセンス管理、AWS アカウント、ネットワークトポロジ、ドメイン
...
現行の `survey/doc_source/non-functional-requirement.md` と本体系のマッピングを以下に示す。

### カテゴリの対応

| 既存 survey の中項目 | 本体系のカテゴリ | 備考 |
|---------------------|-----------------|------|
| 可用性 | 可用性 + セキュリティ | 既存の「コンプライアンス」「パッチ管理」「攻撃防御」「運用アカウント管理」はセキュリティまたは運用・保守性に再分類 |
| 運用 | 運用・保守性 | ほぼそのまま対応 |
| キャパシティ | 性能・拡張性 | 名称を IPA に合わせて変更 |
| 環境 | 環境・エコロジー | サステナビリティの観点を追加 |
| コスト | コスト最適化 | 名称を W-A に合わせて変更 |
| （なし） | 移行性 | 新規追加が必要 |
...
| 既存の位置 | 移動先 | 理由 |
|-----------|--------|------|
| 可用性 > コンプライアンス | セキュリティ > コンプライアンス | 規制準拠はセキュリティの領域 |
| 可用性 > パッチ管理 | 運用・保守性 > 保守運用 | IPA 体系に従い運用・保守性に配置 |
| 可用性 > 攻撃防御 | セキュリティ > ネットワークセキュリティ | 攻撃防御はセキュリティの領域 |
| 可用性 > 運用アカウント管理 | セキュリティ > アクセス制御 | IAM・権限管理はセキュリティの核心 |
