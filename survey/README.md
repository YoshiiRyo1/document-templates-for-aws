...
| ファイル名                    | 内容の説明                                                                 | 質問数 |
| ----------------------------- | -------------------------------------------------------------------------- | ------ |
| nfr-reliability.md            | 信頼性（稼働率、バックアップ、災害対策）                                   | 27     |
| nfr-security.md               | セキュリティ（コンプライアンス、データ保護、ID管理、攻撃防御、パッチ管理） | 47     |
| nfr-operational-excellence.md | 運用上の優秀性（運用体制、ジョブ、ログ、監視、デプロイ）                   | 46     |
| nfr-performance-efficiency.md | パフォーマンス効率（性能目標、拡張性、キャッシュ、テスト）                 | 24     |
| nfr-cost-optimization.md      | コスト最適化                                                               | 15     |
| nfr-sustainability.md         | サステナビリティ                                                           | 7      |
